          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div class="sm:text-center lg:text-left fade-in">
              <div class="inline-flex items-center space-x-2 bg-red-50 px-4 py-2 rounded-full mb-4">
                ...
                <span class="text-sm font-medium text-gray-700">Trusted by 1,000+ financial institutions</span>
              </div>
              <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                <span class="block xl:inline">Streamline Your</span>
                <span class="block text-[#C40F12] xl:inline">
                   Credit Report
                   </span>
              </h1>
              <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
              CreditInfo provides financial institutions with efficient, secure, and cost-effective credit report processing solutions tailored to your specific needs.              </p>
